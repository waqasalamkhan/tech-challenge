...
function GenerateNDCObject(e) {
    ...
    $('.add-new-state-wrapper').html('Generate Data <span class="material-symbols-outlined"> settings </span>');
    ...
    setTimeout(function () {
        ...
        $(e.target).html('Generate Data <span class="material-symbols-outlined"> settings </span>');
