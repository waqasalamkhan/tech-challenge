function Parser(){
  ...
  this.parse = function (message, length){
    let splitted = message.split('\x1c');
    switch(splitted[0][0]){
    case '1':
    ...
    case '8':
      return this.parseEMVConfiguration(splitted);
    default:
  ...
  this.parseEMVConfiguration = function(splitted){
    let parsed = {};
    parsed.message_class = 'EMV Configuration';
    parsed.LUNO = splitted[1];
    parsed.message_sequence_number = splitted[2];

    switch(splitted[3]){
    case '1':
      parsed.message_subclass = 'ICC Currency Data Objects table';
      break;
    case '2':
      parsed.message_subclass = 'ICC Transaction Data Objects table';
      break;
    case '3':
      parsed.message_subclass = 'ICC Language Support table';
      break;
    case '4':
      parsed.message_subclass = 'ICC Terminal Data Objects table';
      break;
    case '5':
      parsed.message_subclass = 'ICC Terminal Acceptable AIDs table';
      break;
    }
    return parsed; 
  };
